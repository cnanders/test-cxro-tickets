...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.location'
        db.alter_column(u'tickets_ticket', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Ticket.location'
        db.alter_column(u'tickets_ticket', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tickets.Location']))
